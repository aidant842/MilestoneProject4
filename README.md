...
4. <strong>Category</strong>
    <p>
        The Category Model only has two fields besides the automatic id field, name and friendly_name, the friendly_name is used to display a nicer looking name to users stoared as a string.
...
6. <strong>Inbox</strong>
    <p>
        ...
        The date_sent is used to show the owner when the message was sent and a way of prioristising messages.
